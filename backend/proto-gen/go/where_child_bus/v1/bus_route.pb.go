...
type GetBusRouteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBusRouteRequest) Reset() {
	*x = GetBusRouteRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBusRouteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBusRouteRequest) ProtoMessage() {}

func (x *GetBusRouteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_where_child_bus_v1_bus_route_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBusRouteRequest.ProtoReflect.Descriptor instead.
func (*GetBusRouteRequest) Descriptor() ([]byte, []int) {
	return file_where_child_bus_v1_bus_route_proto_rawDescGZIP(), []int{2}
}

func (x *GetBusRouteRequest) GetBusId() string {
	if x != nil {
		return x.BusId
	}
	return ""
...
func (x *GetBusRouteRequest) GetBusType() BusType {
	if x != nil {
		return x.BusType
	}
	return BusType_BUS_TYPE_UNSPECIFIED
...
type GetBusRouteResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBusRouteResponse) Reset() {
	*x = GetBusRouteResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBusRouteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBusRouteResponse) ProtoMessage() {}

func (x *GetBusRouteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_where_child_bus_v1_bus_route_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBusRouteResponse.ProtoReflect.Descriptor instead.
func (*GetBusRouteResponse) Descriptor() ([]byte, []int) {
	return file_where_child_bus_v1_bus_route_proto_rawDescGZIP(), []int{3}
}

func (x *GetBusRouteResponse) GetBusRoute() *BusRoute {
	if x != nil {
		return x.BusRoute
	}
	return nil
...
var file_where_child_bus_v1_bus_route_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89, 0x01, 0x0a,
	...
	,
	...
	,
	...
	,
...
var file_where_child_bus_v1_bus_route_proto_goTypes = []interface{}{
	...
	(*GetBusRouteRequest)(nil),     // 2: where_child_bus.v1.GetBusRouteRequest
	(*GetBusRouteResponse)(nil),    // 3: where_child_bus.v1.GetBusRouteResponse
...
var file_where_child_bus_v1_bus_route_proto_depIdxs = []int32{
	...
	4, // 2: where_child_bus.v1.GetBusRouteRequest.bus_type:type_name -> where_child_bus.v1.BusType
	5, // 3: where_child_bus.v1.GetBusRouteResponse.bus_route:type_name -> where_child_bus.v1.BusRoute
	0, // 4: where_child_bus.v1.BusRouteService.CreateBusRoute:input_type -> where_child_bus.v1.CreateBusRouteRequest
	2, // 5: where_child_bus.v1.BusRouteService.GetBusRoute:input_type -> where_child_bus.v1.GetBusRouteRequest
	1, // 6: where_child_bus.v1.BusRouteService.CreateBusRoute:output_type -> where_child_bus.v1.CreateBusRouteResponse
	3, // 7: where_child_bus.v1.BusRouteService.GetBusRoute:output_type -> where_child_bus.v1.GetBusRouteResponse
...
func file_where_child_bus_v1_bus_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_where_child_bus_v1_bus_route_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBusRouteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_where_child_bus_v1_bus_route_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBusRouteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
