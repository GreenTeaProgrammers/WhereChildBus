...
var file_where_child_bus_v1_bus_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x75, 0x73, 0x52, 0x03, 0x62, 0x75, 0x73, 0x32,
	0xd0, 0x02, 0x0a, 0x0a, 0x42, 0x75, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58,
...
var file_where_child_bus_v1_bus_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_where_child_bus_v1_bus_proto_goTypes = []interface{}{
	...
	(*Bus)(nil),                           // 6: where_child_bus.v1.Bus
	(Status)(0),                           // 7: where_child_bus.v1.Status
}
var file_where_child_bus_v1_bus_proto_depIdxs = []int32{
	6, // 0: where_child_bus.v1.CreateBusResponse.bus:type_name -> where_child_bus.v1.Bus
	6, // 1: where_child_bus.v1.GetBusListByNurseryIdResponse.buses:type_name -> where_child_bus.v1.Bus
	7, // 2: where_child_bus.v1.ChangeBusStatusRequest.status:type_name -> where_child_bus.v1.Status
	6, // 3: where_child_bus.v1.ChangeBusStatusResponse.bus:type_name -> where_child_bus.v1.Bus
	...
	1, // 7: where_child_bus.v1.BusService.CreateBus:output_type -> where_child_bus.v1.CreateBusResponse
	3, // 8: where_child_bus.v1.BusService.GetBusListByNurseryId:output_type -> where_child_bus.v1.GetBusListByNurseryIdResponse
	5, // 9: where_child_bus.v1.BusService.ChangeBusStatus:output_type -> where_child_bus.v1.ChangeBusStatusResponse
