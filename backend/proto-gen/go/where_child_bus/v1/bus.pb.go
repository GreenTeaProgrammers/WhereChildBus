...
func (x *CreateBusResponse) GetChildren() []*Child {
	if x != nil {
		return x.Children
	}
	return nil
...
var file_where_child_bus_v1_bus_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x49, 0x64, 0x73, 0x22, 0x75, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42,
	...
	,
	...
	0x62, 0x75, 0x73, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x77, 0x68,
	0x65, 0x72, 0x65, 0x5f, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x5f, 0x62, 0x75, 0x73, 0x2e, 0x76, 0x31,
	0x2e, 0x42, 0x75, 0x73, 0x52, 0x05, 0x62, 0x75, 0x73, 0x65, 0x73, 0x32, 0xe4, 0x01, 0x0a, 0x0a,
...
var file_where_child_bus_v1_bus_proto_goTypes = []interface{}{
	...
	(*Child)(nil),                         // 5: where_child_bus.v1.Child
}
var file_where_child_bus_v1_bus_proto_depIdxs = []int32{
	...
	5, // 1: where_child_bus.v1.CreateBusResponse.children:type_name -> where_child_bus.v1.Child
	4, // 2: where_child_bus.v1.GetBusListByNurseryIdResponse.buses:type_name -> where_child_bus.v1.Bus
	0, // 3: where_child_bus.v1.BusService.CreateBus:input_type -> where_child_bus.v1.CreateBusRequest
	2, // 4: where_child_bus.v1.BusService.GetBusListByNurseryId:input_type -> where_child_bus.v1.GetBusListByNurseryIdRequest
	1, // 5: where_child_bus.v1.BusService.CreateBus:output_type -> where_child_bus.v1.CreateBusResponse
	3, // 6: where_child_bus.v1.BusService.GetBusListByNurseryId:output_type -> where_child_bus.v1.GetBusListByNurseryIdResponse
