...
type GetChildListByNurseryIDResponse struct {
	...
	//
	//	*GetChildListByNurseryIDResponse_Children
	//	*GetChildListByNurseryIDResponse_Photo
	ResponseType isGetChildListByNurseryIDResponse_ResponseType `protobuf_oneof:"response_type"`
}
...
func (m *GetChildListByNurseryIDResponse) GetResponseType() isGetChildListByNurseryIDResponse_ResponseType {
	if m != nil {
...
func (x *GetChildListByNurseryIDResponse) GetChildren() *Children {
	if x, ok := x.GetResponseType().(*GetChildListByNurseryIDResponse_Children); ok {
		return x.Children
	}
	return nil
}
...
func (x *GetChildListByNurseryIDResponse) GetPhoto() *ChildPhoto {
	if x, ok := x.GetResponseType().(*GetChildListByNurseryIDResponse_Photo); ok {
		return x.Photo
	}
	return nil
}

type isGetChildListByNurseryIDResponse_ResponseType interface {
	isGetChildListByNurseryIDResponse_ResponseType()
}

type GetChildListByNurseryIDResponse_Children struct {
	Children *Children `protobuf:"bytes,1,opt,name=children,proto3,oneof"`
}

type GetChildListByNurseryIDResponse_Photo struct {
	Photo *ChildPhoto `protobuf:"bytes,2,opt,name=photo,proto3,oneof"`
}

func (*GetChildListByNurseryIDResponse_Children) isGetChildListByNurseryIDResponse_ResponseType() {}

func (*GetChildListByNurseryIDResponse_Photo) isGetChildListByNurseryIDResponse_ResponseType() {}
...
type GetChildListByGuardianIDResponse struct {
	...
	// Types that are assignable to ResponseType:
	//
	//	*GetChildListByGuardianIDResponse_Children
	//	*GetChildListByGuardianIDResponse_Photo
	ResponseType isGetChildListByGuardianIDResponse_ResponseType `protobuf_oneof:"response_type"`
}
...
func (m *GetChildListByGuardianIDResponse) GetResponseType() isGetChildListByGuardianIDResponse_ResponseType {
	if m != nil {
		return m.ResponseType
	}
	return nil
...
func (x *GetChildListByGuardianIDResponse) GetChildren() *Children {
	if x, ok := x.GetResponseType().(*GetChildListByGuardianIDResponse_Children); ok {
		return x.Children
	}
	return nil
}

func (x *GetChildListByGuardianIDResponse) GetPhoto() *ChildPhoto {
	if x, ok := x.GetResponseType().(*GetChildListByGuardianIDResponse_Photo); ok {
		return x.Photo
	}
	return nil
}

type isGetChildListByGuardianIDResponse_ResponseType interface {
	isGetChildListByGuardianIDResponse_ResponseType()
}

type GetChildListByGuardianIDResponse_Children struct {
	Children *Children `protobuf:"bytes,1,opt,name=children,proto3,oneof"`
}

type GetChildListByGuardianIDResponse_Photo struct {
	Photo *ChildPhoto `protobuf:"bytes,2,opt,name=photo,proto3,oneof"`
}

func (*GetChildListByGuardianIDResponse_Children) isGetChildListByGuardianIDResponse_ResponseType() {}

func (*GetChildListByGuardianIDResponse_Photo) isGetChildListByGuardianIDResponse_ResponseType() {}
...
type GetChildListByBusIDResponse struct {
	...
	// Types that are assignable to ResponseType:
	//
	//	*GetChildListByBusIDResponse_Children
	//	*GetChildListByBusIDResponse_Photo
	ResponseType isGetChildListByBusIDResponse_ResponseType `protobuf_oneof:"response_type"`
}
...
func (m *GetChildListByBusIDResponse) GetResponseType() isGetChildListByBusIDResponse_ResponseType {
	if m != nil {
		return m.ResponseType
	}
	return nil
...
func (x *GetChildListByBusIDResponse) GetChildren() *Children {
	if x, ok := x.GetResponseType().(*GetChildListByBusIDResponse_Children); ok {
		return x.Children
	}
	return nil
}

func (x *GetChildListByBusIDResponse) GetPhoto() *ChildPhoto {
	if x, ok := x.GetResponseType().(*GetChildListByBusIDResponse_Photo); ok {
		return x.Photo
	}
	return nil
}

type isGetChildListByBusIDResponse_ResponseType interface {
	isGetChildListByBusIDResponse_ResponseType()
}

type GetChildListByBusIDResponse_Children struct {
	Children *Children `protobuf:"bytes,1,opt,name=children,proto3,oneof"`
}

type GetChildListByBusIDResponse_Photo struct {
	Photo *ChildPhoto `protobuf:"bytes,2,opt,name=photo,proto3,oneof"`
}

func (*GetChildListByBusIDResponse_Children) isGetChildListByBusIDResponse_ResponseType() {}

func (*GetChildListByBusIDResponse_Photo) isGetChildListByBusIDResponse_ResponseType() {}
...
var file_where_child_bus_v1_child_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0xa6, 0x01, 0x0a, 0x1f, 0x47, 0x65, 0x74, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x4c, 0x69,
	0x73, 0x74, 0x42, 0x79, 0x4e, 0x75, 0x72, 0x73, 0x65, 0x72, 0x79, 0x49, 0x44, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x77, 0x68, 0x65, 0x72, 0x65, 0x5f,
	0x63, 0x68, 0x69, 0x6c, 0x64, 0x5f, 0x62, 0x75, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x69,
	0x6c, 0x64, 0x72, 0x65, 0x6e, 0x48, 0x00, 0x52, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65,
	0x6e, 0x12, 0x36, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x12, 0x84, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x68, 0x69, 0x6c, 0x64,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x87, 0x01, 0x0a, 0x18, 0x47,
	0x65, 0x74, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x79, 0x47, 0x75, 0x61,
	0x72, 0x64, 0x69, 0x61, 0x6e, 0x49, 0x44, 0x12, 0x33, 0x2e, 0x77, 0x68, 0x65, 0x72, 0x65, 0x5f,
	...
	,
...
var file_where_child_bus_v1_child_proto_goTypes = []interface{}{
	...
	(*Children)(nil),                         // 10: where_child_bus.v1.Children
	(*ChildPhoto)(nil),                       // 11: where_child_bus.v1.ChildPhoto
}
var file_where_child_bus_v1_child_proto_depIdxs = []int32{
	...
	10, // 2: where_child_bus.v1.GetChildListByNurseryIDResponse.children:type_name -> where_child_bus.v1.Children
	11, // 3: where_child_bus.v1.GetChildListByNurseryIDResponse.photo:type_name -> where_child_bus.v1.ChildPhoto
	10, // 4: where_child_bus.v1.GetChildListByGuardianIDResponse.children:type_name -> where_child_bus.v1.Children
	11, // 5: where_child_bus.v1.GetChildListByGuardianIDResponse.photo:type_name -> where_child_bus.v1.ChildPhoto
	10, // 6: where_child_bus.v1.GetChildListByBusIDResponse.children:type_name -> where_child_bus.v1.Children
	11, // 7: where_child_bus.v1.GetChildListByBusIDResponse.photo:type_name -> where_child_bus.v1.ChildPhoto
...
func file_where_child_bus_v1_child_proto_init() {
	...
	file_where_child_bus_v1_child_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*GetChildListByNurseryIDResponse_Children)(nil),
		(*GetChildListByNurseryIDResponse_Photo)(nil),
	}
	file_where_child_bus_v1_child_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*GetChildListByGuardianIDResponse_Children)(nil),
		(*GetChildListByGuardianIDResponse_Photo)(nil),
	}
	file_where_child_bus_v1_child_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*GetChildListByBusIDResponse_Children)(nil),
		(*GetChildListByBusIDResponse_Photo)(nil),
	}
	type x struct{}
