...
def serve():
    ...
    machine_learning_pb2_grpc.add_MachineLearningServiceServicer_to_server(HealthCheck(), server)

    # Reflection APIの設定
    SERVICE_NAMES = (
        machine_learning_pb2.DESCRIPTOR.services_by_name['MachineLearningService'].full_name,
