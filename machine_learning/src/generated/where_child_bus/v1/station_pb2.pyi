...
class UpdateStationRequest(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., bus_id: _Optional[str] = ..., latitude: _Optional[float] = ..., longitude: _Optional[float] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
