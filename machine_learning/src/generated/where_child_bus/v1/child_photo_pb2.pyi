...
class DuplicationCheckResponse(_message.Message):
    ...
    def __init__(
        self,
        is_duplicated: bool = ...,
        photo_ids: _Optional[_Iterable[str]] = ...,
        duplicated_photos: _Optional[_Iterable[bytes]] = ...,
    ) -> None: ...
...
class DeleteChildPhotoResponse(_message.Message):
    ...
    def __init__(
        self,
        is_success_list: _Optional[_Iterable[bool]] = ...,
...
class ChildPhotoResponse(_message.Message):
    ...
    photo: bytes
    def __init__(
        self, child_photo_id: _Optional[str] = ..., photo: _Optional[bytes] = ...
    ) -> None: ...
...
class GetChildPhotoResponse(_message.Message):
    ...
    def __init__(
        self,
        child_photos: _Optional[_Iterable[_Union[ChildPhotoResponse, _Mapping]]] = ...,
    ) -> None: ...
