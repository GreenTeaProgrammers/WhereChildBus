...
class ChildServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetChildListByGuardianID = channel.unary_stream(
        ...
        self.GetChildListByBusID = channel.unary_stream(
...
def add_ChildServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetChildListByGuardianID': grpc.unary_stream_rpc_method_handler(
            ...
            'GetChildListByBusID': grpc.unary_stream_rpc_method_handler(
...
class ChildService(object):
    ...
    def GetChildListByGuardianID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/where_child_bus.v1.ChildService/GetChildListByGuardianID',
    ...
    def GetChildListByBusID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/where_child_bus.v1.ChildService/GetChildListByBusID',
